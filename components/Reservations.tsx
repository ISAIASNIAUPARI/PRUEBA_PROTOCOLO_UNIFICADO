      ...
      <div className="inner">
        ...
        {(lead || edit) && (
          <p className="lead reveal">
            <EditableText as="span" edit={edit} value={lead} onChange={(v) => patch({ lead: v })} {...color('lead')} {...sizeWeight('lead')} />
          </p>
        )}
        ...
        {(orText || edit) && (
          <div className="or">
            <EditableText as="span" edit={edit} value={orText} onChange={(v) => patch({ orText: v })} {...color('orText')} {...sizeWeight('orText')} />
          </div>
        )}
        {(phoneDisplay || edit) && (
          <a href={`tel:${phoneNumber || ''}`} className="phone-box" onClick={(e) => edit && e.preventDefault()}>
            ...
            <EditableText as="span" edit={edit} value={phoneDisplay} stopClickNavigation onChange={(v) => patch({ phoneDisplay: v })} {...color('phoneDisplay')} {...sizeWeight('phoneDisplay')} />
          </a>
        )}
        ...
        <div className="res-contact reveal">
          {(contactName || edit) && (
            <div className="nm">
              <EditableText as="span" edit={edit} value={contactName} onChange={(v) => patch({ contactName: v })} {...color('contactName')} {...sizeWeight('contactName')} />
            </div>
          )}
          {(address || edit) && (
            <div>
              ...
              <EditableText as="span" edit={edit} value={address} onChange={(v) => patch({ address: v })} {...color('address')} {...sizeWeight('address')} />
            </div>
          )}
          {(contactEmail || edit) && (
            <div>
              ...
              <EditableText as="span" edit={edit} value={contactEmail} onChange={(v) => patch({ contactEmail: v })} {...color('contactEmail')} {...sizeWeight('contactEmail')} />
            </div>
          )}
        </div>
      </div>
